...
class JuoksijaController extends BaseController {
    //JuoksijaController vastaa juoksija-luokkaan kohdistuvista toimenpiteistä. 
    //Luokassa on myös toiminnot juoksijan liittämiseksi tapahtumaan
    ...
    public static function store() {
        ...
        if (count($errors) == 0) {
            ...
            View::make('asiakas/register.html', array('errors' => $errors, 'attributes' => $attributes));
        }
    }

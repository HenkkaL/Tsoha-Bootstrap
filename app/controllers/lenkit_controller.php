...
class LenkkiController extends BaseController {
    /*LenkkiController huolehtii tapahtuma, lenkki ja startti -luokkiin
     * liittyvistä toimista. Täältä ohjataan tapahtumien luonti, muokkaus
     *  ja poisto */
    ...
    public static function update($id) {
        $lenkki = Tapahtuma::find($id)->lenkki;
        $params = $_POST;
